...
// (Tận dụng lại model Product ông đã tạo lúc làm trang Products)
...
export class HomeService {
  ...
  // 2. Dữ liệu Sản phẩm nổi bật (Trending)
  private mockHotProducts: Product[] = [
    {
      id: 1,
    ...
    },
    {
      ...
      inStock: true,
      image:
        "https://images.unsplash.com/photo-1580480055273-228ff5388ef8?w=300",
    ...
    },
    {
      ...
      inStock: true,
      image:
        "https://images.unsplash.com/photo-1527443154391-4208e9baea10?w=300",
